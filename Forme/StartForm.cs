...
using CheckBoXIndexAPP.Properties;
using CheckBoXIndexAPP.Forms;

namespace CheckBoXIndexAPP
{
    public partial class StartForm : Form
    {
        ...
        private void btnDalje_Click(object sender, EventArgs e)
        {
            ...
            MainForma mainForm = new MainForma(inputPath, outputPath, imeOperatera);
            mainForm.Show();
            this.Hide();
        }
